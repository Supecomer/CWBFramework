...
#import "NSDictionary+MGAdd.h"
#import "NSString+MGAdd.h"
#import "NSData+MGAdd.h"
#import "MGCategoriesMacro.h"

MGSYNTH_DUMMY_CLASS(NSDictionary_MGAdd)


@interface _MGXMLDictionaryParser : NSObject <NSXMLParserDelegate>
@end

@implementation _MGXMLDictionaryParser {
...
@implementation NSDictionary (MGAdd)
...
+ (NSDictionary *)dictionaryWithXML:(id)xml {
    _MGXMLDictionaryParser *parser = nil;
    if ([xml isKindOfClass:[NSString class]]) {
        parser = [[_MGXMLDictionaryParser alloc] initWithString:xml];
    } else if ([xml isKindOfClass:[NSData class]]) {
        parser = [[_MGXMLDictionaryParser alloc] initWithData:xml];
    }
...
@implementation NSMutableDictionary (MGAdd)
