 ...
 */
@interface UIImageView (MGYYWebImage)
 ...
 */
@property (nullable, nonatomic, strong) NSURL *MGYY_highlightedImageURL;
...
/**
 ...
 @param placeholder The image to be set initially, until the image request finishes.
 */
- (void)MGYY_setHighlightedImageWithURL:(nullable NSURL *)imageURL placeholder:(nullable UIImage *)placeholder;
...
/**
 ...
 @param options  The options to use when request the image.
 */
- (void)MGYY_setHighlightedImageWithURL:(nullable NSURL *)imageURL options:(MGYYWebImageOptions)options;
...
/**
 ...
 @param completion  The block invoked (on main thread) when image request completed.
 */
- (void)MGYY_setHighlightedImageWithURL:(nullable NSURL *)imageURL
                          placeholder:(nullable UIImage *)placeholder
                              options:(MGYYWebImageOptions)options
                           completion:(nullable MGYYWebImageCompletionBlock)completion;
