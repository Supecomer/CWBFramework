...
NSString *const _MGYYWebImageFadeAnimationKey = @"MGYYWebImageFade";
const NSTimeInterval _MGYYWebImageFadeTime = 0.2;
const NSTimeInterval _MGYYWebImageProgressiveFadeTime = 0.4;


@implementation _MGYYWebImageSetter {
...
- (int32_t)setOperationWithSentinel:(int32_t)sentinel
    ...
    if (sentinel != _sentinel) {
        if (completion) completion(nil, imageURL, MGYYWebImageFromNone, MGYYWebImageStageCancelled, nil);
        return _sentinel;
    }
