...
#import "UIImageView+MGYYWebImage.h"
#import "MGYYWebImageOperation.h"
#import "_MGYYWebImageSetter.h"
#import <objc/runtime.h>

// Dummy class for category
@interface UIImageView_MGYYWebImage : NSObject @end
@implementation UIImageView_MGYYWebImage @end

static int _MGYYWebImageSetterKey;
static int _MGYYWebImageHighlightedSetterKey;


@implementation UIImageView (MGYYWebImage)
...
- (NSURL *)MGYY_highlightedImageURL {
    _MGYYWebImageSetter *setter = objc_getAssociatedObject(self, &_MGYYWebImageHighlightedSetterKey);
    return setter.imageURL;
}

- (void)setMGYY_highlightedImageURL:(NSURL *)imageURL {
    [self MGYY_setHighlightedImageWithURL:imageURL
                            placeholder:nil
                                options:kNilOptions
                                manager:nil
                               progress:nil
...
- (void)MGYY_setHighlightedImageWithURL:(NSURL *)imageURL placeholder:(UIImage *)placeholder {
    [self MGYY_setHighlightedImageWithURL:imageURL
                            placeholder:placeholder
                                options:kNilOptions
                                manager:nil
...
- (void)MGYY_setHighlightedImageWithURL:(NSURL *)imageURL options:(MGYYWebImageOptions)options {
    [self MGYY_setHighlightedImageWithURL:imageURL
                            placeholder:nil
                                options:options
                                manager:nil
...
- (void)MGYY_setHighlightedImageWithURL:(NSURL *)imageURL
                          placeholder:(UIImage *)placeholder
                              options:(MGYYWebImageOptions)options
                           completion:(MGYYWebImageCompletionBlock)completion {
    [self MGYY_setHighlightedImageWithURL:imageURL
...
- (void)MGYY_setHighlightedImageWithURL:(NSURL *)imageURL
    ...
    if (!setter) {
        setter = [_MGYYWebImageSetter new];
        objc_setAssociatedObject(self, &_MGYYWebImageHighlightedSetterKey, setter, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    int32_t sentinel = [setter cancelWithNewURL:imageURL];
...
- (void)MGYY_cancelCurrentHighlightedImageRequest {
    _MGYYWebImageSetter *setter = objc_getAssociatedObject(self, &_MGYYWebImageHighlightedSetterKey);
    if (setter) [setter cancel];
}
