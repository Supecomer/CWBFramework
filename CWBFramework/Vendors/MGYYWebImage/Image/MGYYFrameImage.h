...
/**
 ...
 The animation can be played by MGYYAnimatedImageView.
 
 Sample Code:
     
     NSArray *paths = @[@"/ani/frame1.png", @"/ani/frame2.png", @"/ani/frame3.png"];
     NSArray *times = @[@0.1, @0.2, @0.1];
     MGYYFrameImage *image = [MGYYFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     MGYYAnimatedImageView *imageView = [MGYYAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface MGYYFrameImage : UIImage <MGYYAnimatedImage>
...
/**
 ...
 @return An initialized MGYYFrameImage object, or nil when an error occurs.
 */
