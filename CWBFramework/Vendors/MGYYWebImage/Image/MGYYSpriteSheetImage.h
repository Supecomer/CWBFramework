...
/**
 ...
 Sample Code:
    ...
    MGYYSpriteSheetImage *sprite;
    sprite = [[MGYYSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    MGYYAnimatedImageView *imgView = [MGYYAnimatedImageView new];
