...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, MGYYImageType) {
    MGYYImageTypeUnknown = 0, ///< unknown
    MGYYImageTypeJPEG,        ///< jpeg, jpg
    MGYYImageTypeJPEG2000,    ///< jp2
    MGYYImageTypeTIFF,        ///< tiff, tif
    MGYYImageTypeBMP,         ///< bmp
    MGYYImageTypeICO,         ///< ico
    MGYYImageTypeICNS,        ///< icns
    MGYYImageTypeGIF,         ///< gif
    MGYYImageTypePNG,         ///< png
    MGYYImageTypeWebP,        ///< webp
    MGYYImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, MGYYImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's canvas region.
     */
    MGYYImageBlendNone = 0,
 ...
 */
@interface MGYYImageFrame : NSObject <NSCopying>
...
@property (nonatomic) MGYYImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) MGYYImageBlendOperation blend;      ///< Frame blend operation.
...
/**
 ...
 Example:
    ...
    MGYYImageDecoder *decoder = [MGYYImageDecoder decoderWithData:data scale:2.0];
    UIImage image = [decoder frameAtIndex:0 decodeForDisplay:YES].image;
 
    // Decode image during download:
    NSMutableData *data = [NSMutableData new];
    MGYYImageDecoder *decoder = [[MGYYImageDecoder alloc] initWithScale:2.0];
 ...
 */
@interface MGYYImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) MGYYImageType type;          ///< Image data type.
 ...
 */
- (nullable MGYYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
...
/**
 ...
 @discussion It supports encoding single frame image with the type defined in MGYYImageType.
 It also supports encoding multi-frame image with GIF, APNG and WebP.
 
 Example:
    
    MGYYImageEncoder *jpegEncoder = [[MGYYImageEncoder alloc] initWithType:MGYYImageTypeJPEG];
    jpegEncoder.quality = 0.9;
    [jpegEncoder addImage:image duration:0];
    NSData jpegData = [jpegEncoder encode];
 
    MGYYImageEncoder *gifEncoder = [[MGYYImageEncoder alloc] initWithType:MGYYImageTypeGIF];
 ...
 */
@interface MGYYImageEncoder : NSObject

@property (nonatomic, readonly) MGYYImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(MGYYImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(MGYYImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(MGYYImageDecoder *)decoder type:(MGYYImageType)type quality:(CGFloat)quality;
...
@interface UIImage (MGYYImageCoder)
 ...
 */
@property (nonatomic) BOOL MGYY_isDecodedForDisplay;
 ...
 */
- (void)MGYY_saveToAlbumWithCompletionBlock:(nullable void(^)(NSURL * _Nullable assetURL, NSError * _Nullable error))completionBlock;
 ...
 */
- (nullable NSData *)MGYY_imageDataRepresentation;
...
CG_EXTERN MGYYImageType MGYYImageDetectType(CFDataRef data);

/// Convert MGYYImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable MGYYImageTypeToUTType(MGYYImageType type);

/// Convert UTI (such as kUTTypeJPEG) to MGYYImageType.
CG_EXTERN MGYYImageType MGYYImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable MGYYImageTypeGetExtension(MGYYImageType type);



/// Returns the shared DeviceRGB color space.
CG_EXTERN CGColorSpaceRef MGYYCGColorSpaceGetDeviceRGB();

/// Returns the shared DeviceGray color space.
CG_EXTERN CGColorSpaceRef MGYYCGColorSpaceGetDeviceGray();

/// Returns whether a color space is DeviceRGB.
CG_EXTERN BOOL MGYYCGColorSpaceIsDeviceRGB(CGColorSpaceRef space);

/// Returns whether a color space is DeviceGray.
CG_EXTERN BOOL MGYYCGColorSpaceIsDeviceGray(CGColorSpaceRef space);



/// Convert EXIF orientation value to UIImageOrientation.
CG_EXTERN UIImageOrientation MGYYUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
CG_EXTERN NSInteger MGYYUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
CG_EXTERN CGImageRef _Nullable MGYYCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable MGYYCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable MGYYCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable MGYYCGImageCreateEncodedData(CGImageRef imageRef, MGYYImageType type, CGFloat quality);


/**
 Whether WebP is available in MGYYImage.
 */
CG_EXTERN BOOL MGYYImageWebPAvailable();
 ...
 */
CG_EXTERN NSUInteger MGYYImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable MGYYCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, MGYYImagePreset) {
    MGYYImagePresetDefault = 0,  ///< default preset.
    MGYYImagePresetPicture,      ///< digital picture, like portrait, inner shot
    MGYYImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    MGYYImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    MGYYImagePresetIcon,         ///< small-sized colorful images
    MGYYImagePresetText          ///< text-like
};
...
/**
 ...
 @param preset        Preset for different image type, default is MGYYImagePresetDefault.
 @return WebP data, or nil if an error occurs.
 */
CG_EXTERN CFDataRef _Nullable MGYYCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             MGYYImagePreset preset);
