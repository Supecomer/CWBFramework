...
/**
 The MGYYWebImageOperation class is an NSOperation subclass used to fetch image 
 from URL request.
 ...
 */
@interface MGYYWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) MGYYImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   MGYYWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(MGYYWebImageOptions)options
                          cache:(nullable MGYYImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable MGYYWebImageProgressBlock)progress
                      transform:(nullable MGYYWebImageTransformBlock)transform
                     completion:(nullable MGYYWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
