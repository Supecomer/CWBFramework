...
@implementation NSString (MGExtension)
...
@implementation NSString (MGExtensionDeprecated_v_2_5_16)
- (NSString *)underlineFromCamel
{
    return self.MG_underlineFromCamel;
}

- (NSString *)camelFromUnderline
{
    return self.MG_camelFromUnderline;
}

- (NSString *)firstCharLower
{
    return self.MG_firstCharLower;
}

- (NSString *)firstCharUpper
{
    return self.MG_firstCharUpper;
}

- (BOOL)isPureInt
{
    return self.MG_isPureInt;
}
